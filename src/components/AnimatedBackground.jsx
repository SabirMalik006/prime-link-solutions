    ...
    <div className={`relative overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute -top-40 -left-40 w-80 h-80 rounded-full blur-3xl" style={{
          background: dark ? "radial-gradient(circle, rgba(14, 165, 233, 0.15) 0%, transparent 70%)" : "radial-gradient(circle, rgba(14, 165, 233, 0.10) 0%, transparent 70%)",
          animation: "pulseOrb 12s ease-in-out infinite"
        }}></div>
        <div className="absolute top-1/2 right-0 w-64 h-64 rounded-full blur-3xl" style={{
          background: dark ? "radial-gradient(circle, rgba(34, 197, 94, 0.12) 0%, transparent 70%)" : "radial-gradient(circle, rgba(34, 197, 94, 0.08) 0%, transparent 70%)",
        ...
        <div className="absolute -bottom-32 left-1/4 w-72 h-72 rounded-full blur-3xl" style={{
          background: dark ? "radial-gradient(circle, rgba(217, 70, 239, 0.08) 0%, transparent 70%)" : "radial-gradient(circle, rgba(217, 70, 239, 0.05) 0%, transparent 70%)",
